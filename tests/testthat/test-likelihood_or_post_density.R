...
test_that("model is 3PLM, 1 dimension, 2 categories, estimator is maximum_aposteriori", {
  ...
  expect_equal(round(post_density[1], 3), -47.993)
  expect_equal(round(attr(post_density, "gradient"), 3), matrix(-3.675))
...
test_that("model is 3PLM, 3 dimensions, 2 categories, estimator is expected_aposteriori", {
  ...
  expect_equal(round(post_density[1], 3), -92.171)
  expect_equal(round(attr(post_density, "gradient"), 3), matrix(c(-11.077, -14.978, -10.078), ncol = 3))
...
test_that("model is GPCM, 1 dimensions, 2 categories, estimator is maximum_aposteriori", {
  ...
  expect_equal(round(post_density[1], 3), -36.891)
  expect_equal(round(attr(post_density, "gradient"), 3), matrix(-8.511))
...
test_that("model is GPCM, 3 dimensions, 4 categories, estimator is expected_aposteriori", {
  ...
  expect_equal(round(post_density[1], 3), -95.13)
  expect_equal(round(attr(post_density, "gradient"), 3), matrix(c(-7.362, -9.081, -10.707), ncol = 3))
...
test_that("model is GPCM, 3 dimensions, varying number of categories, estimator is expected_aposteriori", {
  ...
  expect_equal(round(post_density[1], 3), -154.17)
  expect_equal(round(attr(post_density, "gradient"), 3), matrix(c(-56.799, -53.174, -57.897), ncol = 3))
