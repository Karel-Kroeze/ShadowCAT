...
test_that("estimator is maximum_likelihood, 1 dimension, 2 categories", {
  ...
  estimated_latent_trait <- estimate_latent_trait(estimate, answers, prior, model, administered, number_dimensions, estimator, alpha, beta, guessing, number_itemsteps_per_item, lower_bound, upper_bound, prior_var_safe_nlm = NULL)
...
test_that("test safe_maximum_likelihood", {
  ...
  estimated_latent_trait <- estimate_latent_trait(estimate, answers, prior, model, administered, number_dimensions, estimator, alpha, beta, guessing, number_itemsteps_per_item, lower_bound, upper_bound, prior_var_safe_nlm)
...
test_that("estimator is expected_aposteriori, 1 dimension, 2 categories", {
  ...
  estimated_latent_trait_gauss_hermite <- estimate_latent_trait(estimate, answers, prior, model, administered, number_dimensions, estimator, alpha, beta, guessing, number_itemsteps_per_item, lower_bound, upper_bound, prior_var_safe_nlm = NULL, eap_estimation_procedure = "gauss_hermite_quad")
  estimated_latent_trait_riemann <- estimate_latent_trait(estimate, answers, prior, model, administered, number_dimensions, estimator, alpha, beta, guessing, number_itemsteps_per_item, lower_bound, upper_bound, prior_var_safe_nlm = NULL, eap_estimation_procedure = "riemannsum")
