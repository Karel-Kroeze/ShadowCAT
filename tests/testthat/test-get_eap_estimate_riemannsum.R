...
test_that("normal prior, 1 dimension, without adapt", {
  ...
  eap <- get_eap_estimate_riemannsum(dimension = number_dimensions, 
                                     ...
                                     answers = answers, model = model, items_to_include = administered, number_dimensions = number_dimensions, estimator = "maximum_likelihood", alpha = alpha, beta = beta, guessing = guessing, number_itemsteps_per_item = number_itemsteps_per_item, return_log_likelihood_or_post_density = FALSE)
