...
test_that("minimize is false, log is true", {    
  ll_in_nlm_format <- LL(theta = .3, initiated_test, initiated_person, minimize = FALSE, log = TRUE)
...
test_that("minimize is true, log is true", {
  ll_in_nlm_format <- LL(theta = .3, initiated_test, initiated_person, minimize = TRUE, log = TRUE)
...
test_that("minimize is true, log is false", {
  ll_in_nlm_format <- LL(theta = .3, initiated_test, initiated_person, minimize = TRUE, log = FALSE)
