...
test_that("sum nByDimension is not equal to n", {
  initiated_test <- list(start = list(type = 'nByDimension', nByDimension = 2, n = 9),
                         items = list(Q = 3))
  
  
})

test_that("items load on more than 1 dimension while start type is nByDimension", {
